...
model:{props:"tags",event:"cc"},watch:{tags:function(c){c&&0!=c.length&&(this.tagstr=c.join(" , "))}},data:function(){return{oval:"",tagstr:""}},methods:{getData:function(){if(this.oval==this.tagstr)return this.tags;var c=this.tagstr;if(c&&0!=c.length)return c=c.trim().replace(/[,\uff0c\u3002\.]/g," "),c=c.replace(/\s{2,}/g," "),this.tags=c.split(" "),this.$emit("cc",this.tags),this.tags},_onTagClose:function(c){this.tags.splice(c,1)},showPane:function(h){c.$.show(this.$refs.tagpane);c.$.hide(this.$refs.tagbox);
this.oval=this.tagstr;this.$refs.taginput.focus()},confirm:function(h){c.$.hide(this.$refs.tagpane);c.$.show(this.$refs.tagbox);return this.getData()}}}});
