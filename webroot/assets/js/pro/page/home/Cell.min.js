...
(function(c){function h(a,b){var f=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(f>>16)<<16|f&65535}function g(a,b,f,e,g,d){a=h(h(b,a),h(e,d));return h(a<<g|a>>>32-g,f)}function a(a,b,f,e,d,h,c){return g(b&f|~b&e,a,b,d,h,c)}function b(a,b,f,e,d,h,c){return g(b&e|f&~e,a,b,d,h,c)}function e(a,b,f,e,d,h,c){return g(f^(b|~e),a,b,d,h,c)}function d(f,d){f[d>>5]|=128<<d%32;f[(d+64>>>9<<4)+14]=d;var k=1732584193,c=-271733879,l=-1732584194,m=271733878;for(d=0;d<f.length;d+=16){var n=k;var p=c;var q=l;var r=m;
...
a.total&&(a.percent=a.loaded/a.total*100);d.onProgress(a,b)});c=new FormData;c.append("filename",d&&d.filename?d.filename:"");c.append("file",b);c.append("name",b.name);c.append("size",b.size);c.append("lastModified",b.lastModified);c.append("type",b.type);f.send(c);return e};var d=function(a){this.path=a};d.prototype.onclose=function(a){if(!this.ws)return!1;ws.close()};d.prototype.onopen=function(a){console.log("open")};d.prototype.receive=function(a,b,d){};d.prototype.error=function(a,b){console.log(a)};
d.prototype.path="";d.prototype.Connect=function(){this.conn&&(this.conn.close(),this.conn=null);var a=this,b=h(navigator.userAgent+window.location.host);b=new WebSocket("ws://"+window.location.host+this.path+"?url="+encodeURI(document.location.pathname)+"&sign="+b);b.onopen=this.onopen;b.onclose=this.onclose;b.onmessage=function(b){var f=JSON.parse(b.data);f.iserror?a.error(f.error,b):f.method&&a.receive(f.method,f.args,f.result)};this.conn=b};d.prototype.Send=function(a,b){1==this.conn.readyState&&
this.conn.send(JSON.stringify({method:a,args:b}))};a.NewWS=function(a){return new d(a)};return a});
...
require(["ajax","util","notepad","preparecookie"],function(c,h,g){new Vue({el:"#main-div",components:{notepad:g},data:{isPageOK:!1,formdata:null,baseinfo:{fields:[],areas:[]}},methods:{_onSaved:function(a){}},mounted:function(){var a=this,b=h.getRouterParam(0),e=this;c.NewClient("/api/info").getData("Base").then(function(d){a.baseinfo={formfields:d.formfields,areas:d.areas};"new"!=b&&c.NewClient("/api/app").send("LoadSElem",{iid:b},{busy:e.$el}).then(function(a){e.isPageOK=!0;e.formdata=a},function(a){h.tool.pageErr("\u9519\u8bef",
a.toString())})})}})});define("page/home/Cell",function(){});
