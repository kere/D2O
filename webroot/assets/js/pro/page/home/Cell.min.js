...
define("util",[],function(){function c(a,b,d,e,f){if(d==e)return b[d]==a?d:-1;if(d>e)return-1;var h=d+Math.floor((e-d+1)/2),g=b[h];return g==a?h:g>a?f?c(a,b,h+1,e):c(a,b,d,h-1):f?c(a,b,d,h-1):c(a,b,h+1,e)}function h(a,b,d,e,f,g){if(e==f)return d[e][a]==b?e:-1;if(e>f)return-1;var c=e+Math.floor((f-e+1)/2);var n=d[c][a];return n==b?c:n>b?g?h(a,b,d,c+1,f):h(a,b,d,e,c-1):g?h(a,b,d,e,c-1):h(a,b,d,c+1,f)}var g={DATE_DAY:864E5,DATE_HOUR:36E5,env:function(){var a={},b=navigator.userAgent.toLowerCase();/android/.test(b)?
...
a.toString();d=a.toString().split(".");if(1==d.length)return e;b=-b;d=!0}else if(0==b)return a.toFixed(b);e=Math.pow(10,b);a=(Math.round(a*e)/e).toFixed(b);if(!d)return a;b=a.length;d=Array(b);for(e=0;e<b;e++)d[e]=a[e];for(a=b-1;-1<a&&"0"==d[a];a--)d.pop();return d.join("")},timeAgoStr:function(a,b,d){d||(d=2);a=this.timeAgo(a,b);b="";var e=!0,f,h=0;for(f=a.length-1;-1<f;f--)if(!e||0!=a[f].value)if(e=!1,b+=a[f].value+a[f].label+" ",h++,h==d)break;return b},timeAgo:function(a,b){a="number"==typeof a&&
...
var e,f=d.length;for(e=0;e<f;e++)if(d[e]&&d[e][a]==b)return e;return-1},arrMix:function(a,b,d){for(var e=[],f=0;f<b.length;f++)for(var h=0;h<a.length;h++)-1===e.indexOf(h)&&d(h,f)&&e.push(h)},inArray:function(a,b){for(var d in b)if(b[d]==a)return!0;return!1},setCookie:function(a,b,d){var e="";d&&(e=new Date,e.setTime(e.getTime()+864E5*d),e="; expires="+e.toGMTString());document.cookie=encodeURIComponent(a)+"="+encodeURIComponent(b)+e+"; path=/"},hasCookie:function(a){return(new RegExp("(?:^|;\\s*)"+
...
(function(c){function h(a,b){var d=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(d>>16)<<16|d&65535}function g(a,b,d,f,g,e){a=h(h(b,a),h(f,e));return h(a<<g|a>>>32-g,d)}function a(a,b,d,f,h,e,c){return g(b&d|~b&f,a,b,h,e,c)}function b(a,b,d,f,h,e,c){return g(b&f|d&~f,a,b,h,e,c)}function d(a,b,d,f,h,e,c){return g(d^(b|~f),a,b,h,e,c)}function e(f,e){f[e>>5]|=128<<e%32;f[(e+64>>>9<<4)+14]=e;var k=1732584193,c=-271733879,l=-1732584194,m=271733878;for(e=0;e<f.length;e+=16){var n=k;var p=c;var q=l;var r=m;
...
8*a.length))}function r(a,b){var d=n(a),c=[],h=[];c[15]=h[15]=void 0;16<d.length&&(d=e(d,8*a.length));for(a=0;16>a;a+=1)c[a]=d[a]^909522486,h[a]=d[a]^1549556828;b=e(c.concat(n(b)),512+8*b.length);return f(e(h.concat(b),640))}function u(a){var b="",f;for(f=0;f<a.length;f+=1){var e=a.charCodeAt(f);b+="0123456789abcdef".charAt(e>>>4&15)+"0123456789abcdef".charAt(e&15)}return b}function t(a,b,f){b?f?a=r(unescape(encodeURIComponent(b)),unescape(encodeURIComponent(a))):(a=r(unescape(encodeURIComponent(b)),
...
a.columns,d=e[0].length;if(0===d)return[];var c=Array(d),h,g=a.fields;for(a=0;a<d;a++){var k={};for(h=0;h<f;h++){var n=g[h];k[n]=b?b(h,a):e[h][a]}c[a]=k}return c},serverTime:{diff:0,set:function(a){this.diff=0<a?(new Date).getTime()-1E3*a:0},now:function(){return new Date(this.time())},time:function(){return(new Date).getTime()-this.diff},utctime:function(){var a=this.now();return a.getTime()-a.getTimezoneOffset()}},getUrlVar:function(a){for(var b=window.location.search.substring(1).split("&"),f=
0;f<b.length;f++){var e=b[f].split("=");if(e[0]==a)return decodeURI(e[1])}return null}},b=function(b){this.path=b||a.url;this.isrun=!1;this.timeout=10;this.async=!0;this.pfield="accpt";this.verField="_data_version"};b.prototype.trySetDataVer=function(a){"object"==typeof a&&a[this.verField]&&(a=a[this.verField],this[this.verField]=a,window[this.verField]=a)};b.prototype.getData=function(a,b,e){var f=this;return new Promise(function(d,c){var h=a+(b?JSON.stringify(b):""),g=function(d,c){f.send(a,b,e).then(function(a){a[f.verField]&&
window.localStorage.setItem(h,JSON.stringify(a));d(a)}).catch(function(a){c(a)})};if(window.localStorage){var k=window.localStorage.getItem(h);k?(k=JSON.parse(k))?(e=e||{ver:window[f.verField]},k[f.verField]!=e.ver?g(d,c):d(k)):g(d,c):g(d,c)}else g(d,c)})};b.prototype.sendEx=function(a,b,e){if(!this.isrun)return this.send(a,b,e)};b.prototype.send=function(b,e,d){var f=this,n=this;this.isrun=!0;d=d||{};d.loading&&c.tool.showLoading(this.timeout);d.disable&&c.$.each(d.disable,function(a){a.setAttribute("disabled",
