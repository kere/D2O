...
(function(m){function n(a,b){var d=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(d>>16)<<16|d&65535}function g(a,b,d,c,f,l){a=n(n(b,a),n(c,l));return n(a<<f|a>>>32-f,d)}function a(a,b,d,c,f,l,e){return g(b&d|~b&c,a,b,f,l,e)}function b(a,b,d,c,f,l,e){return g(b&c|d&~c,a,b,f,l,e)}function d(a,b,d,c,f,e,m){return g(d^(b|~c),a,b,f,e,m)}function c(c,f){c[f>>5]|=128<<f%32;c[(f+64>>>9<<4)+14]=f;var h=1732584193,k=-271733879,e=-1732584194,l=271733878;for(f=0;f<c.length;f+=16){var m=h;var p=k;var q=e;var t=l;
...
NewClient:function(a,c){return new b(a,c)},NewUpload:function(a){return new d(a)},DataSet:function(a){this.Fields=a.fields;this.Columns=a.columns;this.Len=function(){return 0==this.Columns.length?0:this.Columns[0].length};this.FieldI=function(a){return this.Fields.indexOf(a)};this.RowAt=function(a){this.Len();for(var b={},c=0;c<this.Fields.length;c++)b[this.Fields[c]]=this.Columns[c][a];return b}},torows:function(a,b){var c=a.fields.length;if(!a||!a.columns||0==a.columns.length||0===c||!a.columns[0])return[];
var d=a.columns,f=d[0].length;if(0===f)return[];var e=Array(f),g,m=a.fields;for(a=0;a<f;a++){var h={};for(g=0;g<c;g++){var k=m[g];h[k]=b?b(g,a):d[g][a]}e[a]=h}return e},serverTime:{diff:0,set:function(a){this.diff=0<a?(new Date).getTime()-1E3*a:0},now:function(){return new Date(this.time())},time:function(){return(new Date).getTime()-this.diff},utctime:function(){var a=this.now();return a.getTime()-a.getTimezoneOffset()}},getUrlVar:function(a){for(var b=window.location.search.substring(1).split("&"),
c=0;c<b.length;c++){var d=b[c].split("=");if(d[0]==a)return decodeURI(d[1])}return null}},b=function(b){this.path=b||a.url;this.isrun=!1;this.timeout=10;this.async=!0;this.pfield="accpt";this.verField="_data_version"};b.prototype.trySetDataVer=function(a){a&&"object"==typeof a&&a[this.verField]&&(a=a[this.verField],this[this.verField]=a,window[this.verField]=a)};b.prototype.getData=function(a,b,c){var d=this;return new Promise(function(f,e){var g=a+(b?JSON.stringify(b):""),m=function(f,e){d.send(a,
b,c).then(function(a){a&&a[d.verField]&&window.localStorage.setItem(g,JSON.stringify(a));f(a)}).catch(function(a){e(a)})};if(window.localStorage){var h=window.localStorage.getItem(g);h?(h=JSON.parse(h))?(c=c||{ver:window[d.verField]},h[d.verField]!=c.ver?m(f,e):f(h)):m(f,e):m(f,e)}else m(f,e)})};b.prototype.sendEx=function(a,b,c){if(!this.isrun)return this.send(a,b,c)};b.prototype.send=function(b,c,d){var f=this,e=this;this.isrun=!0;d=d||{};d.loading&&m.tool.showLoading(this.timeout);d.disable&&m.$.each(d.disable,
function(a){a.setAttribute("disabled",!0)});d.busy&&m.$.each(d.busy,function(a){m.tool.showBusy(a,f.timeout)});var p=d.ts?d.ts:a.serverTime.utctime().toString(),q=window[this.pfield]||"",t=b+p+(c?JSON.stringify(c):"")+navigator.userAgent+p+q+window.location.hostname;return g({async:this.async,url:this.path+"/"+b,data:c,headers:{Accto:n(t),Accts:p,AccPage:q,Api:b},timeout:1E3*this.timeout}).then(function(a){e.isrun=!1;d.loading&&m.tool.hideToast();d.disable&&m.$.each(d.disable,function(a){a.removeAttribute("disabled")});
d.busy&&m.$.each(d.busy,function(a){m.tool.hideBusy(a)});if(""==a)return null;"string"==typeof a&&(a=JSON.parse(a));e.trySetDataVer(a);return a}).catch(function(a,b){e.isrun=!1;d.loading&&m.tool.hideToast();d.disable&&m.$.each(d.disable,function(a){a.removeAttribute("disabled")});d.busy&&m.$.each(d.busy,function(a){m.tool.hideBusy(a)});return Promise.reject(a)})};var d=function(a){this.path=a;this.pfield="accpt";this.verField="_data_version"};d.prototype.upload=function(b,c){var d=new XMLHttpRequest,
f=a.serverTime.utctime().toString(),e=window[this.pfield]||"";d.open("POST",this.path,!0);d.setRequestHeader("Accto",n(f+b.name+b.size+b.lastModified+b.type+navigator.userAgent+f+e+window.location.hostname));d.setRequestHeader("Accts",f);d.setRequestHeader("AccPage",e);f=new Promise(function(a,f){d.onload=function(e){if(200>d.status||300<=d.status)return f(e);a(e.currentTarget.responseText);if(c&&c.onSuccess)c.onSuccess(e.currentTarget.responseText,b)};d.onerror=function(a){f(a)}});c&&c.onProgress&&
...
b){1==this.conn.readyState&&this.conn.send(JSON.stringify({method:a,args:b}))};a.NewWS=function(a){return new c(a)};return a});
