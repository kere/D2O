...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var d=new n;b.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};b.prototype.settleSameAsThenable_=function(a,b){var d=this.createResolveAndReject_();try{a.call(b,d.resolve,d.reject)}catch(p){d.reject(p)}};b.prototype.then=function(a,d){function c(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(h){g(h)}}:b}var e,g,m=new b(function(a,
b){e=a;g=b});this.callWhenSettled_(c(a,e),c(d,g));return m};b.prototype.catch=function(a){return this.then(void 0,a)};b.prototype.callWhenSettled_=function(a,b){function c(){switch(e.state_){case 1:a(e.result_);break;case 2:b(e.result_);break;default:throw Error("Unexpected state: "+e.state_);}}var e=this;null==this.onSettledCallbacks_?d.asyncExecute(c):this.onSettledCallbacks_.push(function(){d.asyncExecute(c)})};b.resolve=g;b.reject=function(a){return new b(function(b,d){d(a)})};b.race=function(a){return new b(function(b,
d){for(var c=$jscomp.makeIterator(a),e=c.next();!e.done;e=c.next())g(e.value).callWhenSettled_(b,d)})};b.all=function(a){var d=$jscomp.makeIterator(a),c=d.next();return c.done?g([]):new b(function(a,b){function e(b){return function(d){f[b]=d;q--;0==q&&a(f)}}var f=[],q=0;do f.push(void 0),q++,g(c.value).callWhenSettled_(e(f.length-1),b),c=d.next();while(!c.done)})};return b},"es6","es3");
define("util",[],function(){function m(a,b,d,c,e){if(d==c)return b[d]==a?d:-1;if(d>c)return-1;var f=d+Math.floor((c-d+1)/2),g=b[f];return g==a?f:g>a?e?m(a,b,f+1,c):m(a,b,d,f-1):e?m(a,b,d,f-1):m(a,b,f+1,c)}function n(a,b,d,c,e,g){if(c==e)return d[c][a]==b?c:-1;if(c>e)return-1;var f=c+Math.floor((e-c+1)/2);var m=d[f][a];return m==b?f:m>b?g?n(a,b,d,f+1,e):n(a,b,d,c,f-1):g?n(a,b,d,c,f-1):n(a,b,d,f+1,e)}var g={DATE_DAY:864E5,DATE_HOUR:36E5,env:function(){var a={},b=navigator.userAgent.toLowerCase();/android/.test(b)?
...
(function(m){function n(a,b){var d=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(d>>16)<<16|d&65535}function g(a,b,d,c,e,k){a=n(n(b,a),n(c,k));return n(a<<e|a>>>32-e,d)}function a(a,b,d,c,e,k,f){return g(b&d|~b&c,a,b,e,k,f)}function b(a,b,d,c,e,k,f){return g(b&c|d&~c,a,b,e,k,f)}function d(a,b,d,c,e,k,f){return g(d^(b|~c),a,b,e,k,f)}function c(c,e){c[e>>5]|=128<<e%32;c[(e+64>>>9<<4)+14]=e;var h=1732584193,l=-271733879,f=-1732584194,k=271733878;for(e=0;e<c.length;e+=16){var m=h;var p=l;var q=f;var t=k;
h=a(h,l,f,k,c[e],7,-680876936);k=a(k,h,l,f,c[e+1],12,-389564586);f=a(f,k,h,l,c[e+2],17,606105819);l=a(l,f,k,h,c[e+3],22,-1044525330);h=a(h,l,f,k,c[e+4],7,-176418897);k=a(k,h,l,f,c[e+5],12,1200080426);f=a(f,k,h,l,c[e+6],17,-1473231341);l=a(l,f,k,h,c[e+7],22,-45705983);h=a(h,l,f,k,c[e+8],7,1770035416);k=a(k,h,l,f,c[e+9],12,-1958414417);f=a(f,k,h,l,c[e+10],17,-42063);l=a(l,f,k,h,c[e+11],22,-1990404162);h=a(h,l,f,k,c[e+12],7,1804603682);k=a(k,h,l,f,c[e+13],12,-40341101);f=a(f,k,h,l,c[e+14],17,-1502002290);
l=a(l,f,k,h,c[e+15],22,1236535329);h=b(h,l,f,k,c[e+1],5,-165796510);k=b(k,h,l,f,c[e+6],9,-1069501632);f=b(f,k,h,l,c[e+11],14,643717713);l=b(l,f,k,h,c[e],20,-373897302);h=b(h,l,f,k,c[e+5],5,-701558691);k=b(k,h,l,f,c[e+10],9,38016083);f=b(f,k,h,l,c[e+15],14,-660478335);l=b(l,f,k,h,c[e+4],20,-405537848);h=b(h,l,f,k,c[e+9],5,568446438);k=b(k,h,l,f,c[e+14],9,-1019803690);f=b(f,k,h,l,c[e+3],14,-187363961);l=b(l,f,k,h,c[e+8],20,1163531501);h=b(h,l,f,k,c[e+13],5,-1444681467);k=b(k,h,l,f,c[e+2],9,-51403784);
f=b(f,k,h,l,c[e+7],14,1735328473);l=b(l,f,k,h,c[e+12],20,-1926607734);h=g(l^f^k,h,l,c[e+5],4,-378558);k=g(h^l^f,k,h,c[e+8],11,-2022574463);f=g(k^h^l,f,k,c[e+11],16,1839030562);l=g(f^k^h,l,f,c[e+14],23,-35309556);h=g(l^f^k,h,l,c[e+1],4,-1530992060);k=g(h^l^f,k,h,c[e+4],11,1272893353);f=g(k^h^l,f,k,c[e+7],16,-155497632);l=g(f^k^h,l,f,c[e+10],23,-1094730640);h=g(l^f^k,h,l,c[e+13],4,681279174);k=g(h^l^f,k,h,c[e],11,-358537222);f=g(k^h^l,f,k,c[e+3],16,-722521979);l=g(f^k^h,l,f,c[e+6],23,76029189);h=g(l^
f^k,h,l,c[e+9],4,-640364487);k=g(h^l^f,k,h,c[e+12],11,-421815835);f=g(k^h^l,f,k,c[e+15],16,530742520);l=g(f^k^h,l,f,c[e+2],23,-995338651);h=d(h,l,f,k,c[e],6,-198630844);k=d(k,h,l,f,c[e+7],10,1126891415);f=d(f,k,h,l,c[e+14],15,-1416354905);l=d(l,f,k,h,c[e+5],21,-57434055);h=d(h,l,f,k,c[e+12],6,1700485571);k=d(k,h,l,f,c[e+3],10,-1894986606);f=d(f,k,h,l,c[e+10],15,-1051523);l=d(l,f,k,h,c[e+1],21,-2054922799);h=d(h,l,f,k,c[e+8],6,1873313359);k=d(k,h,l,f,c[e+15],10,-30611744);f=d(f,k,h,l,c[e+6],15,-1560198380);
l=d(l,f,k,h,c[e+13],21,1309151649);h=d(h,l,f,k,c[e+4],6,-145523070);k=d(k,h,l,f,c[e+11],10,-1120210379);f=d(f,k,h,l,c[e+2],15,718787259);l=d(l,f,k,h,c[e+9],21,-343485551);h=n(h,m);l=n(l,p);f=n(f,q);k=n(k,t)}return[h,l,f,k]}function e(a){var b,e="",c=32*a.length;for(b=0;b<c;b+=8)e+=String.fromCharCode(a[b>>5]>>>b%32&255);return e}function f(a){var b,e=[];e[(a.length>>2)-1]=void 0;for(b=0;b<e.length;b+=1)e[b]=0;var c=8*a.length;for(b=0;b<c;b+=8)e[b>>5]|=(a.charCodeAt(b/8)&255)<<b%32;return e}function p(a){return e(c(f(a),
8*a.length))}function u(a,b){var d=f(a),l=[],g=[];l[15]=g[15]=void 0;16<d.length&&(d=c(d,8*a.length));for(a=0;16>a;a+=1)l[a]=d[a]^909522486,g[a]=d[a]^1549556828;b=c(l.concat(f(b)),512+8*b.length);return e(c(g.concat(b),640))}function v(a){var b="",e;for(e=0;e<a.length;e+=1){var c=a.charCodeAt(e);b+="0123456789abcdef".charAt(c>>>4&15)+"0123456789abcdef".charAt(c&15)}return b}function r(a,b,e){b?e?a=u(unescape(encodeURIComponent(b)),unescape(encodeURIComponent(a))):(a=u(unescape(encodeURIComponent(b)),
unescape(encodeURIComponent(a))),a=v(a)):a=e?p(unescape(encodeURIComponent(a))):v(p(unescape(encodeURIComponent(a))));return a}"function"===typeof define&&define.amd?define("accto",[],function(){return r}):"object"===typeof module&&module.exports?module.exports=r:m.accto=r})(this);
...
NewClient:function(a,c){return new b(a,c)},NewUpload:function(a){return new d(a)},DataSet:function(a){this.Fields=a.fields;this.Columns=a.columns;this.Len=function(){return 0==this.Columns.length?0:this.Columns[0].length};this.FieldI=function(a){return this.Fields.indexOf(a)};this.RowAt=function(a){this.Len();for(var b={},e=0;e<this.Fields.length;e++)b[this.Fields[e]]=this.Columns[e][a];return b}},torows:function(a,b){var c=a.fields.length;if(!a||!a.columns||0==a.columns.length||0===c||!a.columns[0])return[];
var e=a.columns,d=e[0].length;if(0===d)return[];var f=Array(d),g,m=a.fields;for(a=0;a<d;a++){var h={};for(g=0;g<c;g++){var l=m[g];h[l]=b?b(g,a):e[g][a]}f[a]=h}return f},serverTime:{diff:0,set:function(a){this.diff=0<a?(new Date).getTime()-1E3*a:0},now:function(){return new Date(this.time())},time:function(){return(new Date).getTime()-this.diff},utctime:function(){var a=this.now();return a.getTime()-a.getTimezoneOffset()}},getUrlVar:function(a){for(var b=window.location.search.substring(1).split("&"),
c=0;c<b.length;c++){var e=b[c].split("=");if(e[0]==a)return decodeURI(e[1])}return null}},b=function(b){this.path=b||a.url;this.isrun=!1;this.timeout=10;this.async=!0;this.pfield="accpt";this.verField="_data_version"};b.prototype.trySetDataVer=function(a){a&&"object"==typeof a&&a[this.verField]&&(a=a[this.verField],this[this.verField]=a,window[this.verField]=a)};b.prototype.getData=function(a,b,c){var d=this;return new Promise(function(e,f){var g=a+(b?JSON.stringify(b):""),m=function(e,f){d.send(a,
b,c).then(function(a){a&&a[d.verField]&&window.localStorage.setItem(g,JSON.stringify(a));e(a)}).catch(function(a){f(a)})};if(window.localStorage){var h=window.localStorage.getItem(g);h?(h=JSON.parse(h))?(c=c||{ver:window[d.verField]},h[d.verField]!=c.ver?m(e,f):e(h)):m(e,f):m(e,f)}else m(e,f)})};b.prototype.sendEx=function(a,b,c){if(!this.isrun)return this.send(a,b,c)};b.prototype.send=function(b,c,d){var e=this,f=this;this.isrun=!0;d=d||{};d.loading&&m.tool.showLoading(this.timeout);d.disable&&m.$.each(d.disable,
function(a){a.setAttribute("disabled",!0)});d.busy&&m.$.each(d.busy,function(a){m.tool.showBusy(a,e.timeout)});var p=d.ts?d.ts:a.serverTime.utctime().toString(),q=window[this.pfield]||"",t=b+p+(c?JSON.stringify(c):"")+navigator.userAgent+p+q+window.location.hostname;return g({async:this.async,url:this.path+"/"+b,data:c,headers:{Accto:n(t),Accts:p,AccPage:q,Api:b},timeout:1E3*this.timeout}).then(function(a){f.isrun=!1;d.loading&&m.tool.hideToast();d.disable&&m.$.each(d.disable,function(a){a.removeAttribute("disabled")});
d.busy&&m.$.each(d.busy,function(a){m.tool.hideBusy(a)});if(""==a)return null;"string"==typeof a&&(a=JSON.parse(a));f.trySetDataVer(a);return a}).catch(function(a,b){f.isrun=!1;d.loading&&m.tool.hideToast();d.disable&&m.$.each(d.disable,function(a){a.removeAttribute("disabled")});d.busy&&m.$.each(d.busy,function(a){m.tool.hideBusy(a)});return Promise.reject(a)})};var d=function(a){this.path=a;this.pfield="accpt";this.verField="_data_version"};d.prototype.upload=function(b,c){var d=new XMLHttpRequest,
...
b){1==this.conn.readyState&&this.conn.send(JSON.stringify({method:a,args:b}))};a.NewWS=function(a){return new c(a)};return a});require.config(requireOpt);
require(["ajax","util"],function(m,n){new Vue({el:"#main-div",data:{rows:[]},filters:{strdate:function(g){return g?g.substr(0,10):""}},methods:{},mounted:function(){var g=this;n.$.show(this.$el);m.NewClient("/api/info").getData("SElems",null,{loading:!0}).then(function(a){var b=a.fields.indexOf("o_json");g.rows=m.torows(a,function(d,c){return d===b?JSON.parse(a.columns[d][c]):a.columns[d][c]});m.NewClient("/api/info").getData("Base")})}})});define("page/home/Cells",function(){});
