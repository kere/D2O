...
l=d(l,f,k,h,c[e+13],21,1309151649);h=d(h,l,f,k,c[e+4],6,-145523070);k=d(k,h,l,f,c[e+11],10,-1120210379);f=d(f,k,h,l,c[e+2],15,718787259);l=d(l,f,k,h,c[e+9],21,-343485551);h=n(h,m);l=n(l,p);f=n(f,q);k=n(k,t)}return[h,l,f,k]}function e(a){var b,c="",e=32*a.length;for(b=0;b<e;b+=8)c+=String.fromCharCode(a[b>>5]>>>b%32&255);return c}function f(a){var b,c=[];c[(a.length>>2)-1]=void 0;for(b=0;b<c.length;b+=1)c[b]=0;var e=8*a.length;for(b=0;b<e;b+=8)c[b>>5]|=(a.charCodeAt(b/8)&255)<<b%32;return c}function p(a){return e(c(f(a),
8*a.length))}function u(a,b){var d=f(a),l=[],g=[];l[15]=g[15]=void 0;16<d.length&&(d=c(d,8*a.length));for(a=0;16>a;a+=1)l[a]=d[a]^909522486,g[a]=d[a]^1549556828;b=c(l.concat(f(b)),512+8*b.length);return e(c(g.concat(b),640))}function v(a){var b="",c;for(c=0;c<a.length;c+=1){var e=a.charCodeAt(c);b+="0123456789abcdef".charAt(e>>>4&15)+"0123456789abcdef".charAt(e&15)}return b}function r(a,b,c){b?c?a=u(unescape(encodeURIComponent(b)),unescape(encodeURIComponent(a))):(a=u(unescape(encodeURIComponent(b)),
...
a.columns,e=d[0].length;if(0===e)return[];var f=Array(e),g,m=a.fields;for(a=0;a<e;a++){var h={};for(g=0;g<c;g++){var l=m[g];h[l]=b?b(g,a):d[g][a]}f[a]=h}return f},serverTime:{diff:0,set:function(a){this.diff=0<a?(new Date).getTime()-1E3*a:0},now:function(){return new Date(this.time())},time:function(){return(new Date).getTime()-this.diff},utctime:function(){var a=this.now();return a.getTime()-a.getTimezoneOffset()}},getUrlVar:function(a){for(var b=window.location.search.substring(1).split("&"),c=
0;c<b.length;c++){var d=b[c].split("=");if(d[0]==a)return decodeURI(d[1])}return null}},b=function(b){this.path=b||a.url;this.isrun=!1;this.timeout=10;this.async=!0;this.pfield="accpt";this.verField="_data_version"};b.prototype.trySetDataVer=function(a){"object"==typeof a&&a[this.verField]&&(a=a[this.verField],this[this.verField]=a,window[this.verField]=a)};b.prototype.getData=function(a,b,c){var d=this;return new Promise(function(e,f){var g=a+(b?JSON.stringify(b):""),m=function(e,f){d.send(a,b,c).then(function(a){a[d.verField]&&
window.localStorage.setItem(g,JSON.stringify(a));e(a)}).catch(function(a){f(a)})};if(window.localStorage){var h=window.localStorage.getItem(g);h?(h=JSON.parse(h))?(c=c||{ver:window[d.verField]},h[d.verField]!=c.ver?m(e,f):e(h)):m(e,f):m(e,f)}else m(e,f)})};b.prototype.sendEx=function(a,b,c){if(!this.isrun)return this.send(a,b,c)};b.prototype.send=function(b,c,d){var e=this,f=this;this.isrun=!0;d=d||{};d.loading&&m.tool.showLoading(this.timeout);d.disable&&m.$.each(d.disable,function(a){a.setAttribute("disabled",
!0)});d.busy&&m.$.each(d.busy,function(a){m.tool.showBusy(a,e.timeout)});var p=d.ts?d.ts:a.serverTime.utctime().toString(),q=window[this.pfield]||"",t=b+p+(c?JSON.stringify(c):"")+navigator.userAgent+p+q+window.location.hostname;return g({async:this.async,url:this.path+"/"+b,data:c,headers:{Accto:n(t),Accts:p,AccPage:q,Api:b},timeout:1E3*this.timeout}).then(function(a){f.isrun=!1;d.loading&&m.tool.hideToast();d.disable&&m.$.each(d.disable,function(a){a.removeAttribute("disabled")});d.busy&&m.$.each(d.busy,
function(a){m.tool.hideBusy(a)});if(""==a)return null;"string"==typeof a&&(a=JSON.parse(a));f.trySetDataVer(a);return a}).catch(function(a,b){f.isrun=!1;d.loading&&m.tool.hideToast();d.disable&&m.$.each(d.disable,function(a){a.removeAttribute("disabled")});d.busy&&m.$.each(d.busy,function(a){m.tool.hideBusy(a)});return Promise.reject(a)})};var d=function(a){this.path=a;this.pfield="accpt";this.verField="_data_version"};d.prototype.upload=function(b,c){var d=new XMLHttpRequest,e=a.serverTime.utctime().toString(),
...
this.conn.send(JSON.stringify({method:a,args:b}))};a.NewWS=function(a){return new c(a)};return a});require.config(requireOpt);
